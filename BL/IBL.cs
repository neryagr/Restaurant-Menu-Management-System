...
namespace BL
{
    public interface IBL
    {
        ...
        float get_profit_client(string card);
        float get_profit_dish(string dish);
        float get_profit_bruanch(string bruanch_number);
        float calculate_order(string order_name);
        Client most_profitable_client();
        Braunch most_profitable_bruanch();
        Dish most_profitable_dish();
         string most_profitable_time(choise c);
        #endregion
        void open();
    }
}
